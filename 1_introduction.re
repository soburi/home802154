...
@<b>{6LoWPAN} は IPv@<b>{6} over @<b>{L}ow poser @<b>{W}ireless @<b>{P}ersonal @<b>{A}rea @<b>{N}etworks
...
XBee/XBee Pro S1 802.15.4@<fn>{1},
XBee S2C@<fn>{2}がある。
...
モノワイヤレス株式会社@<fn>{3} (以下TOCOS)から発売されている
NXPのJN5164のOEM品(?)がTWE-Lite@<fn>{4}である。
国内の技適を取得しており、国内で @<strong>{合法的} に問題なく使うことができる。
無線モジュール形態での提供に加えて、DIP28サイズのブレイクアウトボードに
実装したもの@<fn>{5}が、秋葉原などの電子部品店を通して供給されており、ホビーユースとしての
...
//footnote[1][@<href>{https://www.digi.com/products/xbee-rf-solutions/embedded-rf-modules-modems/xbee-802-15-4}]

//footnote[2][@<href>{https://www.digi.com/support/productdetail?pid=3257}]

//footnote[3][@<href>{http://tocos-wireless.com}]

//footnote[4][@<href>{http://tocos-wireless.com/jp/products/TWE-001Lite.html}]

//footnote[5][@<href>{http://tocos-wireless.com/jp/products/TWE-Lite-DIP/index.html}]
